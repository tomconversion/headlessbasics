...
import PopoverDemo from '@/ui-base/components/ui/demo/popoverDemo';

// Use the following variable to control the technical template contents
const demoJson = [{}];
const title = "Popover";
const description = "Opens a tooltip like window. When the user clicks elsewhere it will close.";
var data = {};
