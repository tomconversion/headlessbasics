...
import TabsDemo from '@/components/ui/demo/tabsDemo';
import { Textarea } from '@/components/ui/textarea';
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/components/ui/tooltip';
import { TooltipArrow } from '@radix-ui/react-tooltip';
import { Button } from '@/components/ui/button';
import { PlusIcon } from '@radix-ui/react-icons';
import TooltipDemo from '@/components/ui/demo/tooltipDemo';

// Use the following variable to control the technical template contents
const demoJson = [{}];
const title = "Tooltip";
const description = "This is a interactive component.";
