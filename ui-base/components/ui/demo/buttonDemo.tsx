...
const buttonDemo = () => (
  <>
    <div className="w-full break-after-auto py-4">
      <div className="w-full columns-12 break-after-auto py-4">
        <div className="w-full px-4">
          <Button variant={"destructive"}>destructive</Button>
        </div>
        <div className="w-full px-4">
          <Button variant={"destructive"} color={"accent"}>
            destructive accent
          </Button>
        </div>
        <div className="w-full px-4">
        ...
        <div className="w-full px-4">
          <Button variant={"destructive"} color={"secondary"} size={"lg"}>
            destructive secondary
          </Button>
        </div>
        <div className="w-full px-4">
          <Button variant={"destructive"} color={"success"}>
            destructive success
          </Button>
        </div>
        <div className="w-full px-4">
          <Button variant={"destructive"} color={"warning"} size={"lg"}>
            destructive warning
          </Button>
        </div>
      </div>
